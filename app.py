...
def admin_dash():
    if session.get('user') == None:
        ...
        return render_template("homepage_admin.html", firstname=str(session['firstname']), lastname=str(session['lastname']))
...
def consumer_dash():
    if session.get('user') == None:
        ...
        return render_template("homepage_consumer.html", firstname=str(session['firstname']), lastname=str(session['lastname']), curuser=str(session['user']))
    else:
